...
<span style="color:red; font-weight:bold;">Important:</span>. Normals are only available in GeoTiff format, while all other data are available in GeoTiff, nc, asci, or bil format. `get_prism_normals()` functions only download the data in GeoTiff format. All other functions *should* work with all formats. 
